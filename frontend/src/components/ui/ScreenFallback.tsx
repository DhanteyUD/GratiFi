...
function ScreenFallback({ message, subText }: ScreenFallbackProps) {
  return (
    <div className="flex h-[calc(100vh-200px)] md:h-[calc(100vh-115px)] overflow-hidden justify-center items-center md:bg-white rounded-[20px] md:border md:border-primary">
